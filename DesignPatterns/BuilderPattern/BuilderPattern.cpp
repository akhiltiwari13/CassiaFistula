...
/*
 * BUILDER PATTERN- When piecewise object construction is complicated, provides
 * and API for doing it succinctly. This program employs builder pattern in
 * creating and HTML renderer.
 */
...
struct HtmlElement {
  ...
  std::string str(int indent = 0) const {
    ...
    std::string i(indent_size * indent,
                  ' '); // spaces to be inserted for indenting html tags.
